...
import Models.Animation.AnimationData;
import Models.Animation.JointTransformData;
import Models.Animation.KeyFrameData;
...
public class AnimatedLoader {
	...
	public AnimatedLoader(XmlNode animationData, XmlNode jointHierarchy){
