...
public class ShadowBox {
	...
	public void update() {
		...
		toFar.scale(Configuration.SHADOW_DISTANCE);
		Vector3f toNear = new Vector3f(forwardVector);
		toNear.scale(Configuration.CAMERA_NEAR_PLANE);
	...
	private void calculateWidthsAndHeights() {
		farWidth = (float) (Configuration.SHADOW_DISTANCE * Math.tan(Math.toRadians(Configuration.CAMERA_FOV)));
		nearWidth = (float) (Configuration.CAMERA_NEAR_PLANE * Math.tan(Math.toRadians(Configuration.CAMERA_FOV)));
